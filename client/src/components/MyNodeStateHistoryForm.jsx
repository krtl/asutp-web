...
export default class MyNodeStateHistoryForm extends React.Component {
  constructor(props) {
    ...
    this.handleReloadStateValuesClick = this.handleReloadStateValuesClick.bind(this);
    }
  ...
  render() {
    return (
      ...
      <div className="field-line">
        ...
        />
        <RaisedButton onClick={this.handleReloadStateValuesClick}>Reload</RaisedButton>
      </div>      
      <Table height='300px'>
        ...
        <TableBody displayRowCheckbox={false}>
          {this.props.stateValues.map(stateValue => (
            <TableRow key={stateValue.dt}>
              ...
              <TableRowColumn><Moment format='YYYY.MM.DD HH:mm:ss'>{stateValue.dt}</Moment></TableRowColumn>
            </TableRow>))
          }
        </TableBody>
      </Table>
...
MyNodeStateHistoryForm.propTypes = {
  ...
  stateValues: PropTypes.arrayOf(PropTypes.shape({
     nodeName: PropTypes.string,
